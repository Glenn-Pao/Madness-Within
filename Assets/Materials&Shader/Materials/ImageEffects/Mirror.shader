//This is the mirror reflection shader code
//It needs to be modified to suit the stereo rendering for the VR gears

Shader "ImageEffects/Mirror"
{
	//The standard properties of this shader
	Properties
	{
