...
Shader "BasicShaders/TintedTilesTexture"
{
...
#include "UnityCG.cginc"
					...
					{
						//multiply the UVs by 2 then multiply the color and the tint
						float4 color = tex2D(_MainTex, i.uv * 2) * _Color *  float4(i.uv.r, i.uv.g, 1, 1);
						return color;
					}
						ENDCG
				}
